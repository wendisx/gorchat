...
CREATE TABLE `im_users_role` (
  ...
  `role_name` varchar(32) not null unique COMMENT '职责名称',
  `created_time` timestamp default current_timestamp COMMENT '职责创建时间',
  `updated_time` timestamp default current_timestamp COMMENT '职责更新时间',
  `deleted` int default 0 COMMENT '逻辑删除'
)ENGINE=InnoDB auto_increment=1 default CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

insert into `im_users_role`(`role_name`) values ('owner');
insert into `im_users_role`(`role_name`) values ('admin');
insert into `im_users_role`(`role_name`) values ('joiner');
...
CREATE TABLE `im_groups_users` (
  ...
  `user_role_nickname` varchar(32) default '' COMMENT '用户职责别称',
  `disturb` int default 1 COMMENT '群打扰模式',
  `created_time` timestamp default current_timestamp COMMENT '用户入群时间',
  `updated_time` timestamp default current_timestamp COMMENT '用户退出群时间',
  `deleted` int default 0 COMMENT '逻辑删除',
...
CREATE TABLE `im_single_chat` (
  ...
  `inviter_nickname` varchar(32) default '' COMMENT '邀请人别称',
  `invitee_nickname` varchar(32) default '' COMMENT '受邀人别称',
  `inviter_disturb` int default 1 COMMENT '邀请人打扰模式',
  `invitee_disturb` int default 1 COMMENT '受邀请人打扰模式',
  `created_time` timestamp default current_timestamp COMMENT '单聊创建时间',
  `updated_time` timestamp default current_timestamp COMMENT '单聊修改时间',
  `deleted` int default 0 COMMENT '逻辑删除',
...
insert into `im_dialog`(`dialog_name`) values ('single');
insert into `im_dialog`(`dialog_name`) values ('group');
...
CREATE TABLE `im_message_type` (
  ...
  `created_time` timestamp default current_timestamp COMMENT '类型创建时间',
  `updated_time` timestamp default current_timestamp COMMENT '类型更新时间',
  `deleted` int default 0 COMMENT '逻辑删除'
)ENGINE=InnoDB default CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

insert into `im_message_type`(`type_name`) values ('text');
insert into `im_message_type`(`type_name`) values ('image');
insert into `im_message_type`(`type_name`) values ('audio');
insert into `im_message_type`(`type_name`) values ('video');
insert into `im_message_type`(`type_name`) values ('link');
...
CREATE TABLE `im_message_status` (
  ...
  `created_time` timestamp default current_timestamp COMMENT '状态创建时间',
  `updated_time` timestamp default current_timestamp COMMENT '状态更新时间',
  `deleted` int default 0 COMMENT '逻辑删除'
)ENGINE=InnoDB default CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

insert into `im_message_status`(`status_name`) values ('Unread');
insert into `im_message_status`(`status_name`) values ('Read');
insert into `im_message_status`(`status_name`) values ('WithDrawn');
insert into `im_message_status`(`status_name`) values ('Resent');
insert into `im_message_status`(`status_name`) values ('Discarded');
